...
Magnetometer::Data Magnetometer::read() const
{
  ...
  return {
            MAGNETIC_MAPPING[0][0] * temp.x + MAGNETIC_MAPPING[0][1] * temp.y + MAGNETIC_MAPPING[0][2] * temp.z,
            MAGNETIC_MAPPING[1][0] * temp.x + MAGNETIC_MAPPING[1][1] * temp.y + MAGNETIC_MAPPING[1][2] * temp.z,
            MAGNETIC_MAPPING[2][0] * temp.x + MAGNETIC_MAPPING[2][1] * temp.y + MAGNETIC_MAPPING[2][2] * temp.z
         };
}
